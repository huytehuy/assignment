...
function enformat(element){
  ...
  document.getElementsByClassName("total")[0].getElementsByClassName("col-12")[3].getElementsByTagName("span")[0].innerText = enformat(String(Number(document.getElementsByClassName("total")[0].getElementsByClassName("col-12")[0].getElementsByTagName("span")[0].innerText)+ 0)) + "(đ)";
